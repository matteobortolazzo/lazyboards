...
func TestFirstLaunch_StartsInConfigMode(t *testing.T) {
	b := NewBoard(nil, nil, nil, nil, "owner", "repo", "github", 0, 0, 0, "Working", false, true, nil)
	if b.mode != configMode {
...
func TestFirstLaunch_PrePopulatesProviderAzure(t *testing.T) {
	b := NewBoard(nil, nil, nil, nil, "owner", "repo", "azure-devops", 0, 0, 0, "Working", false, true, nil)
...
func TestFirstLaunch_PrePopulatesRepo(t *testing.T) {
	b := NewBoard(nil, nil, nil, nil, "myowner", "myrepo", "github", 0, 0, 0, "Working", false, true, nil)
...
func TestFirstLaunch_EmptyRepoNotPrePopulated(t *testing.T) {
	b := NewBoard(nil, nil, nil, nil, "", "", "github", 0, 0, 0, "Working", false, true, nil)
...
func TestConfigMode_PrePopulatesProviderFromRuntime(t *testing.T) {
	...
	b := NewBoard(p, nil, nil, nil, "owner", "repo", "github", 0, 0, 0, "Working", false, false, nil)
...
func TestConfigMode_PrePopulatesRepoFromRuntime(t *testing.T) {
	p := provider.NewFakeProvider()
	b := NewBoard(p, nil, nil, nil, "myowner", "myrepo", "github", 0, 0, 0, "Working", false, false, nil)
	board, _ := p.FetchBoard(context.TODO())
	m, _ := b.Update(boardFetchedMsg{board: board})
	b = m.(Board)
