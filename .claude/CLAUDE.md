...
- When adding new production or test files, add corresponding rows to the File Structure tables in `.claude/CLAUDE.md` — keep file-level documentation synchronized with actual structure.
